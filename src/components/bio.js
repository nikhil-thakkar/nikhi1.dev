      ...
      render={data => {
        ...
        return (
          <Container>
            ...
            />
            <div>
              <p style={{margin:0}}>{data.site.siteMetadata.author}</p>
              <TwitterIcon/>
              <GitHubIcon/>
            </div>
          </Container>
